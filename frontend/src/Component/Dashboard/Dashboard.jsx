...
const Dashboard = () => {
  return (
    <div className="flex h-screen">
      <Sidebar />
      <div className="h-screen w-full flex flex-col justify-center items-center bg-stone-100 p-6 relative overflow-hidden">
        <div className=""></div>

        <h1 className="text-green-900 text-6xl font-extrabold tracking-wide mb-4 shadow-lg animate-shimmer">
          Welcome to Dalia Store
        </h1>
